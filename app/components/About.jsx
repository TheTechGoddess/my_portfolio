...
const About = () => {
  return (
    <div
      name="about"
      className="w-full min-h-screen py-16 md:py-20 bg-[#000] text-gray-300 flex justify-center items-center"
    >
          ...
          <div>
            <div className="space-y-3">
              <p>
                ...
                building performant and scalable web applications with Vue 3/Nuxt
                3 and React/Next.js. Frontend engineering is where I have the most
                professional experience, with a focus on state management,
                reusable component architecture, modern styling, and building
              ...
              <p>
                ...
                user-focused products. My approach emphasizes reusable solutions,
                thoughtful architecture, and maintainable code that teams can
