    ...
    <div name="home" className="w-full h-screen bg-[#000] text-[#FDE7EF] ">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <p className="text-[#889] py-4 max-w-[700px]">
          I'm a Frontend Developer with 2 years experience in determining the
          structure of webpages and ensuring web design is optimized for smart
          phones, and building reuseable code
        </p>
        <div>
